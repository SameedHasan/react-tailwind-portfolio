...
const Portfolio = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-lg p-4 pt-4 mx-auto flex flex-col justify-center w-full h-full">
        <div className="pt-14">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 px-3 sm:px-0">
